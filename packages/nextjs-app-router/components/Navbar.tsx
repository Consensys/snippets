...
/* @cheatsheet
    {
        ...
        "step": 4,
        "title": "Import the MetaMask Context",
        "description": "Make sure to wrap your app with the MetaMask Context Provider. This component should be a child of the MetaMask Context Provider."
    }
    */
  ...
  /*@cheatsheet
    {
        "flow": "Connect to MetaMask",
        "step": 5,
        "title": "Use the MetaMask Context",
        "description": "The MetaMask Context provides the SDK instance, the account, and the connection status and more."
    }
    */
