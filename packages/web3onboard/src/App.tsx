/* @module
 * @title Web3Onboard initialization with metamask
...
/**
 * @title Import the metamask sdk
 *
 * @description Use this instead of regular metamask sdk
 */
import metamaskSDK from "@web3-onboard/metamask";

/**
 * @title Imports from web3-onboard
 *
 * @description init and useConnectWallet are imported from web3-onboard
 */
...
/**
 * @title Initialize metamask sdk
 *
 * @description Initialize the metamask sdk with the options
 */
...
/**
 * @title Call init from web3-onboard
 *
 * @description This will initialize the web3-onboard with the metamask sdk and other wallets
 */
...
function App() {
  /**
   * @title Hook that provides the wallet and the connecting state
   *
   * @description
   */
  ...
  return (
    <>
      <div>
        {/**
         * @title Show the connected  accounts
         *
         * @description
         */}
